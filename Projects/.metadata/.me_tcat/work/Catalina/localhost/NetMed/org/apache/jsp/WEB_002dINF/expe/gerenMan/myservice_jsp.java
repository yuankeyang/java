...
public final class myservice_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
	...
	//String name = (String) session.getAttribute("expename");
      ...
      out.write("/expe/OfflineConsultFormBriefForRead',\r\n");
      out.write("\t\t\ttype : 'POST',\r\n");
      ...
      out.write("\t\t\t\tvar th=$(\"<thead><tr> <th>序号</th><th>患者 </th><th>姓名 </th><th>病情简介 </th><th>咨询时间</th><th colSpan='2'>相关操作</th></tr></thead>\");\r\n");
      ...
      out.write("\t\t\t\t\tvar s1 = \"<tr><td><a title=\\\"查看详情\\\" target=\\\"_blank\\\" href='OfflineConsultFormDetailForRead?electronic_record=\"+ data.OfflineConsultArray[index].electronic_record+ \"'>\"\t+ (index + 1)+ \"</a></td>\";\r\n");
      out.write("\t\t\t\t\tvar s2 =\"<td>\"+data.OfflineConsultArray[index].userId+\"</td>\";\r\n");
      out.write("\t\t\t\t\tvar s3 =\"<td>\"+data.OfflineConsultArray[index].consultName+\"</td>\";\r\n");
      out.write("\t\t\t\t\tvar s4 =\"<td>\"+data.OfflineConsultArray[index].brief+\"</td>\";\r\n");
      out.write("\t\t\t\t\tvar s5 = \"<td>\"+data.OfflineConsultArray[index].time+\"</td>\";\r\n");
      out.write("\t\t\t\t\tvar s6 = \"<td class=\\\"offAccount\\\"><a title=\\\"查看详情\\\" target=\\\"_blank\\\" href='OfflineConsultFormDetailForRead?electronic_record=\"+ data.OfflineConsultArray[index].electronic_record+ \"'>查看</a></td>\";\r\n");
      out.write("\t\t\t\t\tvar s7 = \"<td class=\\\"offAccount\\\"><a title=\\\"追加意见\\\" target=\\\"_blank\\\" href='OfflineConsultFormDetailForAppend?electronic_record=\"+ data.OfflineConsultArray[index].electronic_record+ \"'>修改</a></td></tr>\";\r\n");
      out.write("\t\t\t\t\tvar tr=$(s1+s2+s3+s4+s5+s6+s7);\r\n");
      ...
      out.write("\t\t<span><h3>已处理的离线表单</h3></span> \r\n");
      out.write("\r\n");
      out.write("    <hr></hr>\r\n");
      out.write("\t</div>\r\n");
      out.write("\r\n");
      ...
      out.write("\t\t\t\t<h3>\r\n");
      out.write("\t\t\t\t\t总共有（<a id=\"recAID\" href=\"javascript:void(0)\">0</a>）条记录\r\n");
      out.write("\t\t\t\t</h3>\r\n");
