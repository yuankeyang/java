...
public final class gerenInfo_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
	...
	String expeId = (String) session.getAttribute("expename");
      ...
      out.write("/expe/UpdateExpePersonInfoAction',\r\n");
      out.write("\t\t\ttype : 'get',\r\n");
      out.write("\t\t\tdata:\"expe_name=\"+$('#username1').val()+\"&expe_mobile=\"+$('#phone1').val()+\"&expe_mail=\"+$('#mail1').val(),\r\n");
      ...
      out.write("\t        url : '");
      out.print(templateUrl);
      out.write("/expe/GetExpePersonInfoAction',\r\n");
      out.write("\t        type : 'POST',\r\n");
      out.write("\t        contentType: \"application/x-www-form-urlencoded; charset=utf-8\", \r\n");
