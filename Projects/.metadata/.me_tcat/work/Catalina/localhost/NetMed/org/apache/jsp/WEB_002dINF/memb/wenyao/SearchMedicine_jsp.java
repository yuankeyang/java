...
public final class SearchMedicine_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
	...
	String searchSelect ="wenyao";
      ...
      out.write("/SearchMedicineAction?pageIndex='+(pageIndex+1),\r\n");
      out.write("    type : 'POST',\r\n");
      ...
      out.write("\t   \r\n");
      out.write("\t\twestMeditotal = data.number.NwestMedi;\r\n");
      out.write("       // alert(data.number.Nprescrip);\r\n");
      out.write("\t  // 显示药物列表\r\n");
      out.write("          $(\"#westmedi_list\").html(\"\");\r\n");
      out.write("\t\t  $.each(data.westMediArray, function(index) {\r\n");
      out.write("\t\t\t     var picture=data.westMediArray[index].Picture;\r\n");
      out.write("\t\t\t\t var s1=\"<li><img src=\\\"");
      out.print(templateUrl);
      out.write("/\"+ picture\r\n");
      out.write("\t\t\t\t\t\t\t\t+ \"\\\" /><div class=\\\"midiMess\\\"><p class=\\\"midiName\\\">\"\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t+ data.westMediArray[index].Name\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t+ \"</p>\";\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\tvar s2 = \"<p class=\\\"midiText\\\">\"\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t+ data.westMediArray[index].Function\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t+ \"</p></div>\";\r\n");
      ...
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t+ data.westMediArray[index].Usage\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t+ \"</p></div>\";\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\tvar s4 = \"<div class=\\\"midiUse\\\"><p class=\\\"midiUseName\\\">[ 禁忌症]</p>\"\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t+\"<p class=\\\"midiUseText\\\">\"\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t+ data.westMediArray[index].Contraindication\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t+ \"</p></div>\";\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\tvar s5 = \"<div class=\\\"midiMore\\\"><div class=\\\"midiMoreText\\\"><a href='MedicineDetail?mediId=\"\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t+ data.westMediArray[index].MediId\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t+ \"&search_strD=\"\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t+ $('#search_str').val()\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t+ \"'><span class=\\\"left\\\">查看</span><span class=\\\"right\\\">详情</span></a></div></div></li>\";\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t$(\"#westmedi_list\").html(\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t$(\"#westmedi_list\").html()+ s1+s2+st1+s3+st1+s4+st1+s5);\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t});\r\n");
      out.write("$(\".megas512\").hide();\r\n");
      out.write("\t\t\t\t\t\t\t\t\t$(\"#Pagination1\").pagination(westMeditotal, { //recordCount在后台定义的一个公有变量，通过从数据库查询记录进行赋值，返回记录的总数\r\n");
      ...
      out.write("\t\t\t\t\t\t\t\t\t\r\n");
      out.write("\t\t\t\t\t\t\t\t//}\r\n");
      out.write("\t\t\tprescriptotal = data.number.Nprescrip;\r\n");
      out.write("\t\t\t//方剂\r\n");
      out.write("\t\t\t $(\"#prescrip_list\").html(\"\");\r\n");
      out.write("\t\t\t $.each(data.prescripArray, function(index) {\r\n");
      out.write("\t\t\t     var picture=data.prescripArray[index].Picture;\r\n");
      out.write("\t\t\t     var s1=\"<li><img src=\\\"");
      out.print(templateUrl);
      out.write("/\"+ picture\r\n");
      out.write("\t\t\t\t\t+ \"\\\" /><div class=\\\"midiMess\\\"><p class=\\\"midiName\\\">\"\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t+ data.prescripArray[index].Name\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t+ \"</p>\";\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\tvar s2 = \"<p class=\\\"midiText\\\">\"\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t+ data.prescripArray[index].Function\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t+ \"</p></div>\";\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\tvar st1 =\"<span class=\\\"midiInter\\\"></span>\";\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\tvar s3 = \"<div class=\\\"midiUse\\\"><p class=\\\"midiUseName\\\">[ 主治 ]</p>\"\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t+\"<p class=\\\"midiUseText\\\">\"\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t+ data.prescripArray[index].MajorFunction\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t+ \"</p></div>\";\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\tvar s4 = \"<div class=\\\"midiUse\\\"><p class=\\\"midiUseName\\\">[ 注意事项 ]</p>\"\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t+\"<p class=\\\"midiUseText\\\">\"\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t+ data.prescripArray[index].Precaution\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t+ \"</p></div>\";\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\tvar s5 = \"<div class=\\\"midiMore\\\"><div class=\\\"midiMoreText\\\"><a href='MedicineDetail?mediId=\"\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t+ data.prescripArray[index].MediId\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t+ \"&search_strD=\"\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t+ $('#search_str').val()\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t+ \"'><span class=\\\"left\\\">查看</span><span class=\\\"right\\\">详情</span></a></div></div></li>\";\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t$(\"#prescrip_list\").html(\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t$(\"#prescrip_list\").html()+ s1+s2+st1+s3+st1+s4+st1+s5);\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t});\r\n");
      out.write("\t\t\t $(\".megas512\").hide();\r\n");
      out.write("\t\t\t\t\t\t\t\t\t$(\"#Pagination2\").pagination(prescriptotal, { //recordCount在后台定义的一个公有变量，通过从数据库查询记录进行赋值，返回记录的总数\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\trecordCount : 30,\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\tcallback : pageselectCallback, //点击分页时，调用的回调函数  \r\n");
      out.write("\t\t\t\t\t\t\t\t\t\tprev_text : '« 上一页', //显示上一页按钮的文本  \r\n");
      out.write("\t\t\t\t\t\t\t\t\t\tnext_text : '下一页 »', //显示下一页按钮的文本  \r\n");
      ...
      out.write("\t\t\t\t\t\t\t\t\t//分页插件左右两边显示的按钮数目  \r\n");
      out.write("\t\t\t\t\t\t\t\t\t}); //分页功能结束\r\n");
      out.write("\t\t\tmediMatetotal = data.number.NmediMate;\r\n");
      out.write("\t\t\t\r\n");
      out.write("\t\t\t\t\t\t\t\t\t//中药材\r\n");
      out.write("\t\t\t $(\"#medimate_list\").html(\"\");\r\n");
      out.write("\t\t\t $.each(data.MediMateArray, function(index) {\r\n");
      out.write("\t\t\t     var picture=data.MediMateArray[index].Picture;\r\n");
      out.write("\t\t\t     var s1=\"<li><img src=\\\"");
      out.print(templateUrl);
      out.write("/\"+ picture\r\n");
      out.write("\t\t\t\t\t+ \"\\\" /><div class=\\\"midiMess\\\"><p class=\\\"midiName\\\">\"\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t+ data.MediMateArray[index].Name\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t+ \"</p>\";\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\tvar s2 = \"<p class=\\\"midiText\\\">\"\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t+ data.MediMateArray[index].Function\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t+ \"</p></div>\";\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\tvar st1 =\"<span class=\\\"midiInter\\\"></span>\";\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\tvar s3 = \"<div class=\\\"midiUse\\\"><p class=\\\"midiUseName\\\">[ 主治 ]</p>\"\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t+\"<p class=\\\"midiUseText\\\">\"\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t+ data.MediMateArray[index].MajorFunction\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t+ \"</p></div>\";\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\tvar s4 = \"<div class=\\\"midiUse\\\"><p class=\\\"midiUseName\\\">[ 注意事项 ]</p>\"\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t+\"<p class=\\\"midiUseText\\\">\"\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t+ data.MediMateArray[index].Precaution\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t+ \"</p></div>\";\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\tvar s5 = \"<div class=\\\"midiMore\\\"><div class=\\\"midiMoreText\\\"><a href='MedicineDetail?mediId=\"\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t+ data.MediMateArray[index].MediId\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t+ \"&search_strD=\"\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t+ $('#search_str').val()\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t+ \"'><span class=\\\"left\\\">查看</span><span class=\\\"right\\\">详情</span></a></div></div></li>\";\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t$(\"#medimate_list\").html(\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t$(\"#medimate_list\").html()+ s1+s2+st1+s3+st1+s4+st1+s5);\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t});\r\n");
      out.write("\t\t\t $(\".megas512\").hide();\r\n");
      out.write("\t\t\t\t\t\t\t\t\t$(\"#Pagination3\").pagination(mediMatetotal, { //recordCount在后台定义的一个公有变量，通过从数据库查询记录进行赋值，返回记录的总数\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\trecordCount : 30,\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\tcallback : pageselectCallback, //点击分页时，调用的回调函数  \r\n");
      out.write("\t\t\t\t\t\t\t\t\t\tprev_text : '« 上一页', //显示上一页按钮的文本  \r\n");
      out.write("\t\t\t\t\t\t\t\t\t\tnext_text : '下一页 »', //显示下一页按钮的文本  \r\n");
      ...
      out.write("\t\t\t\t\t\t\t\t\t}); //分页功能结束\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\r\n");
      out.write("\t\tpateMeditotal = data.number.NpateMedi;\r\n");
      out.write("\t\t//中成药\r\n");
      out.write("\t\t $(\"#patemedi_list\").html(\"\");\r\n");
      out.write("\t\t $.each(data.pateMediArray, function(index) {\r\n");
      out.write("\t\t\t     var picture=data.pateMediArray[index].Picture;\r\n");
      out.write("\t\t\t     var s1=\"<li><img src=\\\"");
      out.print(templateUrl);
      out.write("/\"+ picture\r\n");
      out.write("\t\t\t\t\t+ \"\\\" /><div class=\\\"midiMess\\\"><p class=\\\"midiName\\\">\"\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t+ data.pateMediArray[index].Name\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t+ \"</p>\";\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\tvar s2 = \"<p class=\\\"midiText\\\">\"\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t+ data.pateMediArray[index].Function\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t+ \"</p></div>\";\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\tvar st1 =\"<span class=\\\"midiInter\\\"></span>\";\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\tvar s3 = \"<div class=\\\"midiUse\\\"><p class=\\\"midiUseName\\\">[ 用法用量 ]</p>\"\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t+\"<p class=\\\"midiUseText\\\">\"\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t+ data.pateMediArray[index].Usage\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t+ \"</p></div>\";\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\tvar s4 = \"<div class=\\\"midiUse\\\"><p class=\\\"midiUseName\\\">[ 注意事项 ]</p>\"\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t+\"<p class=\\\"midiUseText\\\">\"\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t+ data.pateMediArray[index].Precaution\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t+ \"</p></div>\";\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\tvar s5 = \"<div class=\\\"midiMore\\\"><div class=\\\"midiMoreText\\\"><a href='MedicineDetail?mediId=\"\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t+ data.pateMediArray[index].MediId\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t+ \"&search_strD=\"\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t+ $('#search_str').val()\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t+ \"'><span class=\\\"left\\\">查看</span><span class=\\\"right\\\">详情</span></a></div></div></li>\";\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t$(\"#patemedi_list\").html(\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t$(\"#patemedi_list\").html()+s1+s2+st1+s3+st1+s4+st1+s5);\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t});\r\n");
      out.write("\t\t    $(\".megas512\").hide();\r\n");
      out.write("\t\t\t\t\t\t\t\t$(\"#Pagination4\").pagination(pateMeditotal, { //recordCount在后台定义的一个公有变量，通过从数据库查询记录进行赋值，返回记录的总数\r\n");
      out.write("\t\t\t\t\t\t\t\t\trecordCount : 30,\r\n");
      out.write("\t\t\t\t\t\t\t\t\tcallback : pageselectCallback, //点击分页时，调用的回调函数  \r\n");
      out.write("\t\t\t\t\t\t\t\t\tprev_text : '« 上一页', //显示上一页按钮的文本  \r\n");
      out.write("\t\t\t\t\t\t\t\t\tnext_text : '下一页 »', //显示下一页按钮的文本  \r\n");
      ...
      out.write("\t\t\t\t\t<span>西药</span>\r\n");
      out.write("\t\t\t\t</div>\r\n");
      out.write("\t\t\t</li>\r\n");
      out.write("\t\t\t<li>\r\n");
      out.write("\t\t\t\t<div class=\"con\">\r\n");
      out.write("\t\t\t\t\t<span>方剂</span>\r\n");
      out.write("\t\t\t\t</div>\r\n");
      out.write("\t\t\t</li>\r\n");
      out.write("\t\t\t<li>\r\n");
      out.write("\t\t\t\t<div class=\"con\">\r\n");
      out.write("\t\t\t\t\t<span>中药</span>\r\n");
      out.write("\t\t\t\t</div>\r\n");
      out.write("\t\t\t</li>\r\n");
      out.write("\t\t\t<li>\r\n");
      out.write("\t\t\t\t<div class=\"con\">\r\n");
      out.write("\t\t\t\t\t<span class=\"left\">中成</span>\r\n");
      out.write("\t\t\t\t\t<span class=\"right\">药</span>\r\n");
      out.write("\t\t\t\t</div>\r\n");
      out.write("\t\t\t</li>\r\n");
      out.write("\t\t</ul>\r\n");
      out.write("\t\t\r\n");
      ...
      out.write("\t\t\r\n");
      out.write("\t\t<div>\r\n");
      out.write("\t\t<ul id=\"westmedi_list\" class=\"midiCon\">\r\n");
      out.write("\t\t</ul>\r\n");
      out.write("\t\t<div id=\"Pagination1\" class=\"megas512\"></div>\r\n");
      out.write("\t\t</div>\r\n");
      out.write("\t\t\r\n");
      out.write("\t\t<div><ul id=\"prescrip_list\" class=\"midiCon\">\r\n");
      out.write("\t\t</ul>\r\n");
      out.write("\t\t<div id=\"Pagination2\" class=\"megas512\"></div>\r\n");
      out.write("\t\t</div>\r\n");
      out.write("\t\t\r\n");
      out.write("\t\t<div>\r\n");
      out.write("\t\t<ul id=\"medimate_list\" class=\"midiCon\">\r\n");
      out.write("\t\t</ul>\r\n");
      out.write("\t\t<div id=\"Pagination3\" class=\"megas512\"></div>\r\n");
      out.write("\t\t</div>\r\n");
      out.write("\t\t\r\n");
      out.write("\t\t<div>\r\n");
      out.write("\t\t<ul id=\"patemedi_list\" class=\"midiCon\">\r\n");
      out.write("\t\t</ul>\r\n");
