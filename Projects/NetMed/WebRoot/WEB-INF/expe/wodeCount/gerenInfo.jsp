...
<script type="text/javascript">
	...
	function submit(){
		$.ajax({
	        url : '<%=templateUrl%>/expe/UpdateExpePersonInfoAction',
			type : 'get',
			data:"expe_name="+$('#username1').val()+"&expe_mobile="+$('#phone1').val()+"&expe_mail="+$('#mail1').val(),
	...
	function getGeRenInfo(){
		$.ajax({
	        url : '<%=templateUrl%>/expe/GetExpePersonInfoAction',
	        type : 'POST',
	        contentType: "application/x-www-form-urlencoded; charset=utf-8", 
			 dataType : 'json',
			 timeout : 8000,
...
<div><img src="${url}/imgs/left.png"/>&nbsp;&nbsp;<span style="font-family:'宋体';font-size:33px;color:#c9b28b;">修改信息</span>&nbsp;&nbsp;<img src="${url}/imgs/right.png"/></div>
