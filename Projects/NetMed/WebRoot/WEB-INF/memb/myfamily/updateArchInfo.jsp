...
function update(){
			$.ajax({
		        url : '<%=templateUrl%>/user/UpdateArchInfo',
			type : 'POST',
			data : {
				"address" : $('#address').val(),
				"age" : $('#age').val(),
...
<%=ArchInfo_Id%>
	,
				...
				"mariStat" : $('#mariStat').val(),
				"province" : $('#province').val(),
				"city" : $('#city').val(),
				"county" : $('#county').val(),
				"occupation" : $('#occupation').val(),
				"guomin" : $('#guomin').val(),
				"fami_hist" : $('#fami_hist').val(),
				"pers_hist" : $('#pers_hist').val(),
				"licence" : $('#licence').val(),
				"meditype" : $('#meditype').val()
			},
			contentType : "application/x-www-form-urlencoded; charset=utf-8",
			dataType : 'text',
			timeout : 8000,
...
<body>
	<div>
		<img src="${url}/imgs/left.png" />&nbsp;&nbsp;<span
			style="font-family:'FangSong';font-size:30pt;color:#c9b28b;">电子健康档案
		</span>&nbsp;&nbsp;<img src="${url}/imgs/right.png" />
	</div>
	<span
		style="font-color:#FF0000;font-family:'宋体';font-size:24pt;bold;margin-left:250px">[更新电子健康档案]</span>
	<div class="archContent" style="margin-top:30px;width:700px;margin-left:30px">
		...
		<div style="margin-left:50px">
				...
				<div id="mysubmit" style="margin-left:180px;margin-top:15px">
