	...
	<div class="chooseMidi">
		...
		<!----查询结果---->
			...
			<div style="margin-left:550px">
				...
				<p>
					<a target="_blank" href="http://baike.baidu.com/link?url=XsBq1rT-9aX58HUR5AZfrJFuKCF097dU2ga7uY0PC_XWw3eNVCCFoNadjCEcs19ysFjP4UyuSNLyfXdx44Zgqq">猪血汤</a>、
					<a target="_blank" href="http://baike.baidu.com/view/42340.htm">红枣</a>。
				</p>
				<p style="font-size:16px">4.穴位按摩：</p>
				<p style="font-size:16px">（睡前揉按15分钟，以酸胀为宜）</p>
				<p style="font-size:16px">血海：在大腿内侧，髌底内侧端上2寸，当股四头肌内侧头的隆起处；屈膝取穴。</p>
				<img src="image/xuewei04.png"> <br />
				<p style="font-size:16px">内关：前臂正中，腕横纹上2寸</p>
               <img src="image/xuewei06.png"> <br />		
			</div>
			<br/><br/>
